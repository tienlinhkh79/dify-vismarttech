...
const AudioPlayer: React.FC<AudioPlayerProps> = ({ src, srcs }) => {
  ...
  return (
    <div className="flex h-9 max-w-[420px] min-w-[240px] items-center gap-2 radius-lg border border-components-panel-border-subtle bg-components-chat-input-audio-bg-alt p-2 shadow-xs backdrop-blur-xs">
