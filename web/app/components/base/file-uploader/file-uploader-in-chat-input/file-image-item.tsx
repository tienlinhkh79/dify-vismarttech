      ...
      >
        ...
        />
        {
          progress >= 0 && !fileIsUploaded(file) && (
            <div className="inset-0 absolute z-10 flex items-center justify-center border-2 border-effects-image-frame bg-background-overlay-alt">
              <ProgressCircle
                percentage={progress}
                size={12}
        ...
        {
          progress === -1 && (
            <div className="inset-0 absolute z-10 flex items-center justify-center border-2 border-state-destructive-border bg-background-overlay-destructive">
              <ReplayLine
                className="h-5 w-5"
