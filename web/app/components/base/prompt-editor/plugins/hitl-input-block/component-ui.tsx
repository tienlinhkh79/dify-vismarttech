...
const HITLInputComponentUI: FC<HITLInputComponentUIProps> = ({
  ...
  return (
    <div
      className="group relative flex h-8 w-full items-center radius-md border-[1.5px] border-components-input-border-active bg-background-default-hover pr-0.5 pl-1.5 select-none"
    >
