...
const Tooltip = ({
  ...
  return (
    <div className="group relative z-10 size-[18px] overflow-visible">
      ...
      <div className="flex h-full w-full items-center justify-center radius-xs bg-state-base-hover transition-all duration-500 ease-in-out group-hover:rounded-none group-hover:bg-saas-dify-blue-static">
