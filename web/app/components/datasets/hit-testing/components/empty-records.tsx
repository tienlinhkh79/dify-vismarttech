...
const EmptyRecords = () => {
  ...
  return (
    <div className="rounded-2xl bg-workflow-process-bg p-5">
      <div className="flex h-10 w-10 items-center justify-center radius-lg border-[0.5px] border-components-card-border bg-components-card-bg p-1 shadow-lg shadow-shadow-shadow-5 backdrop-blur-[5px]">
