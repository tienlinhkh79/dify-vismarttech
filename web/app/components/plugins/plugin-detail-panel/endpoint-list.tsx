  ...
  return (
    <div className={cn('border-divider-subtle px-4 py-2', showTopBorder && 'border-t')}>
      ...
      {data.endpoints.length === 0 && (
        <div className="mb-1 flex justify-center radius-lg bg-background-section p-3 system-xs-regular text-text-tertiary">{t('detailPanel.endpointsEmpty', { ns: 'plugin' })}</div>
      )}
      <div className="flex flex-col gap-2">
