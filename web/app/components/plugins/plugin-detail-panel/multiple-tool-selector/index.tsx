  ...
  return (
    <>
      ...
      {!collapse && (
        <>
          {value.length === 0 && (
            <div className="flex justify-center radius-lg bg-background-section p-3 system-xs-regular text-text-tertiary">{t('detailPanel.toolSelector.empty', { ns: 'plugin' })}</div>
          )}
