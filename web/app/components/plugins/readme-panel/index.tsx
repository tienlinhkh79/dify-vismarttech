...
const ReadmePanel: FC = () => {
  ...
  const portalContent = showType === ReadmeShowType.drawer
    ? (
        <div className="inset-0 fixed z-999 flex justify-start" onClick={onClose}>
          <div
            className={cn(
    ...
    : (
        <div className="inset-0 fixed z-999 flex items-center justify-center p-2" onClick={onClose}>
          <div
            className={cn(
