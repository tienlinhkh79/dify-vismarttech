...
const PublishToast = () => {
  ...
  return (
    <div className="pointer-events-none absolute right-0 bottom-[45px] left-0 z-10 flex justify-center">
      ...
      >
        <div className="inset-0 pointer-events-none absolute bg-linear-to-r from-components-badge-status-light-normal-halo to-background-gradient-mask-transparent opacity-[0.4]">
        </div>
