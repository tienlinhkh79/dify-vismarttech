...
const DeliveryMethodForm: React.FC<Props> = ({
  ...
  return (
    <div className="px-4 py-2">
      ...
      {!value.length && (
        <div className="flex items-center justify-center radius-lg bg-background-section p-3 system-xs-regular text-text-tertiary">{t(`${i18nPrefix}.deliveryMethod.emptyTip`, { ns: 'workflow' })}</div>
      )}
      {value.length > 0 && (
