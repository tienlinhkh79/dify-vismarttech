...
const Recipient = ({
  ...
  return (
    <div className="space-y-1">
      ...
      <div className="flex h-10 items-center gap-2 radius-lg border-[0.5px] border-components-panel-border bg-components-panel-on-panel-item-bg pr-3 pl-2.5 shadow-xs">
