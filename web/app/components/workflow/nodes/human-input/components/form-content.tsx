...
const Key: FC<{ children: React.ReactNode, className?: string }> = ({ children, className }) => {
  return <span className={cn('mx-0.5 inline-flex size-4 items-center justify-center radius-xs bg-components-kbd-bg-gray system-kbd text-text-placeholder', className)}>{children}</span>
}
