...
const VariableItem = ({
  ...
  return (
    <div className={cn(
      'mb-1 radius-md border border-components-panel-border-subtle bg-components-panel-on-panel-item-bg px-2.5 py-2 shadow-xs hover:bg-components-panel-on-panel-item-bg-hover',
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex shrink-0 items-center gap-1 text-text-tertiary">
          <div className="cursor-pointer radius-md p-1 hover:bg-state-base-hover hover:text-text-secondary">
            <RiEditLine className="h-4 w-4" onClick={() => onEdit(item)} />
          </div>
          <div
            className="cursor-pointer radius-md p-1 hover:bg-state-destructive-hover hover:text-text-destructive"
