    ...
    >
      ...
      {showTip && (
        <div className="shrink-0 px-3 pt-2.5 pb-2">
          <div className="relative radius-2xl bg-background-section-burn p-3">
            ...
            <div className="flex items-center gap-2">
              <div className="flex flex-col radius-lg border border-workflow-block-border bg-workflow-block-bg p-3 pb-4 shadow-md">
