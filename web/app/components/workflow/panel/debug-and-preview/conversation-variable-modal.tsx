      ...
      <div className="flex h-full w-full">
        ...
        <div className="flex h-full w-[224px] shrink-0 flex-col border-r border-divider-burn bg-background-sidenav-bg">
          ...
          <div className="grow overflow-y-auto px-3 py-2">
            {varList.map(chatVar => (
              <div key={chatVar.id} className={cn('group mb-0.5 flex cursor-pointer items-center radius-md p-2 hover:bg-state-base-hover', currentVar.id === chatVar.id && 'bg-state-base-hover')} onClick={() => setCurrentVar(chatVar)}>
