...
const EnvItem = ({
  ...
  return (
    <div className={cn(
      'group mb-1 radius-md border border-components-panel-border-subtle bg-components-panel-on-panel-item-bg shadow-xs hover:bg-components-panel-on-panel-item-bg-hover',
