...
const DisplayContent = (props: DisplayContentProps) => {
  ...
  return (
    <div className={cn('flex h-full flex-col radius-lg bg-components-input-bg-normal', isFocused && 'bg-components-input-bg-active outline-1 outline-components-input-border-active outline-solid', className)}>
